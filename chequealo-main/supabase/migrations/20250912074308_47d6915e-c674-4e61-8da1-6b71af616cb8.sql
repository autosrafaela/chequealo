...
('a1234567-e89b-12d3-a456-426614174004', 'Reparación de Motor', 'Diagnóstico y reparación de problemas de motor', 50000, 200000, 'ARS'),

-- María López - Abogada
('a1234567-e89b-12d3-a456-426614174005', 'Asesoramiento Legal', 'Consulta jurídica por hora', 8000, 12000, 'ARS'),
('a1234567-e89b-12d3-a456-426614174005', 'Divorcio de Común Acuerdo', 'Trámite completo de divorcio consensuado', 40000, 80000, 'ARS'),
...
('a1234567-e89b-12d3-a456-426614174013', 'Plan Nutricional', 'Plan nutricional personalizado mensual', 15000, 25000, 'ARS'),
...
('a1234567-e89b-12d3-a456-426614174002', '11111111-1111-1111-1111-111111111111', 4, 'José solucionó el problema rápidamente. Precio justo.', 'Destapación de Cloacas'),
('a1234567-e89b-12d3-a456-426614174004', '11111111-1111-1111-1111-111111111112', 4, 'Buen mecánico, sabe lo que hace. El auto quedó perfecto.', 'Service Completo'),
('a1234567-e89b-12d3-a456-426614174008', '11111111-1111-1111-1111-111111111113', 5, 'Roberto es un excelente veterinario. Muy cuidadoso con mi mascota.', 'Consulta Veterinaria'),
('a1234567-e89b-12d3-a456-426614174012', '11111111-1111-1111-1111-111111111114', 5, 'Fernando es un gran profesor. Mi hijo avanzó muchísimo en guitarra.', 'Clases de Guitarra'),
('a1234567-e89b-12d3-a456-426614174020', '11111111-1111-1111-1111-111111111115', 4, 'Martín es muy profesional. Me ayudó a alcanzar mis objetivos.', 'Entrenamiento Personal');
...
('a1234567-e89b-12d3-a456-426614174003', '/placeholder.svg', 'Cableado completo de vivienda nueva', 'Instalación Eléctrica', 'professional'),
...
('a1234567-e89b-12d3-a456-426614174014', '/placeholder.svg', 'Placard empotrado de 3 cuerpos', 'Placards', 'professional'),
('a1234567-e89b-12d3-a456-426614174015', '/placeholder.svg', 'Limpieza post-obra departamento', 'Limpieza Post-Obra', 'professional'),
('a1234567-e89b-12d3-a456-426614174015', '/placeholder.svg', 'Resultado final limpieza profunda', 'Limpieza Doméstica', 'client');