...
('123e4567-e89b-12d3-a456-426614174017', '20202020-2020-2020-2020-202020202020', 'Natalia Sosa', 'Profesora de Inglés', 'Santa Fe, Santa Fe', 'Clases de inglés para niños, adolescentes y adultos. Preparación para exámenes internacionales (Cambridge, TOEFL). Método comunicativo con énfasis en conversación.', '+54 342 789012', 'natalia.sosa@email.com', 4.8, 20, true, 'Disponible hoy', null),

-- Profesional 18: Raúl Pereyra - Pintor
('123e4567-e89b-12d3-a456-426614174018', '30303030-3030-3030-3030-303030303030', 'Raúl Pereyra', 'Pintor', 'Rafaela, Santa Fe', 'Pintura de casas, departamentos y comercios. Especialista en técnicas decorativas, empapelado y revestimientos texturados. Presupuestos gratuitos y materiales de primera calidad.', '+54 3492 890123', 'raul.pereyra@email.com', 4.3, 13, false, 'Disponible mañana', null),

-- Profesional 19: Claudia Giménez - Contadora
('123e4567-e89b-12d3-a456-426614174019', '40404040-4040-4040-4040-404040404040', 'Claudia Giménez', 'Contadora Pública', 'Esperanza, Santa Fe', 'Servicios contables integrales para empresas y monotributistas. Liquidación de sueldos, IVA y Ganancias. Asesoramiento en planeamiento tributario y financiero.', '+54 3496 901234', 'claudia.gimenez@email.com', 4.9, 26, true, 'Disponible próxima semana', null),

-- Profesional 20: Martín Acosta - Entrenador Personal
('123e4567-e89b-12d3-a456-426614174020', '50505050-5050-5050-5050-505050505050', 'Martín Acosta', 'Entrenador Personal', 'Rafaela, Santa Fe', 'Entrenamiento personalizado y funcional. Especialista en pérdida de peso, tonificación muscular y rehabilitación deportiva. Clases individuales y grupales, en gimnasio o domicilio.', '+54 3492 012345', 'martin.acosta@email.com', 4.6, 29, true, 'Disponible esta semana', null);
...
-- Fernando Ruiz - Profesor de Música
...
-- Martín Acosta - Entrenador Personal
...
('123e4567-e89b-12d3-a456-426614174001', '11111111-1111-1111-1111-111111111101', 5, 'Excelente profesional, muy detallada en su trabajo. Me ayudó mucho con los impuestos de mi empresa.', 'Balance General'),
('123e4567-e89b-12d3-a456-426614174001', '11111111-1111-1111-1111-111111111102', 5, 'Ana es súper responsable y siempre cumple con los plazos. La recomiendo 100%.', 'Liquidación de IVA'),
('123e4567-e89b-12d3-a456-426614174001', '11111111-1111-1111-1111-111111111103', 4, 'Muy buen servicio, aunque a veces tarda en responder los mensajes.', 'Asesoramiento Tributario'),

('123e4567-e89b-12d3-a456-426614174002', '11111111-1111-1111-1111-111111111104', 4, 'José solucionó el problema de la cañería rápidamente. Precio justo.', 'Destapación de Cloacas'),
('123e4567-e89b-12d3-a456-426614174002', '11111111-1111-1111-1111-111111111105', 4, 'Buen trabajo, llegó puntual y dejó todo limpio.', 'Reparación de Canillas'),

('123e4567-e89b-12d3-a456-426614174003', '11111111-1111-1111-1111-111111111106', 5, 'Laura es una genia! Solucionó un problema eléctrico que otros no pudieron. Súper recomendable.', 'Reparación de Tablero'),
('123e4567-e89b-12d3-a456-426614174003', '11111111-1111-1111-1111-111111111107', 5, 'Trabajo impecable, muy prolija y explica todo lo que hace.', 'Instalación Eléctrica Completa'),

('123e4567-e89b-12d3-a456-426614174007', '11111111-1111-1111-1111-111111111108', 5, 'Sofía me ayudó muchísimo con mis problemas de ansiedad. Excelente profesional.', 'Terapia Individual'),
('123e4567-e89b-12d3-a456-426614174007', '11111111-1111-1111-1111-111111111109', 5, 'Muy empática y comprensiva. Realmente se nota su experiencia.', 'Terapia de Pareja'),

('123e4567-e89b-12d3-a456-426614174015', '11111111-1111-1111-1111-111111111110', 5, 'Luciana y su equipo son fantásticos. Siempre dejan la casa impecable.', 'Limpieza Doméstica'),
('123e4567-e89b-12d3-a456-426614174015', '11111111-1111-1111-1111-111111111111', 4, 'Muy buen servicio, puntuales y responsables.', 'Limpieza Post-Obra');
...
('123e4567-e89b-12d3-a456-426614174003', '/placeholder.svg', 'Instalación de tablero eléctrico residencial', 'Instalación Eléctrica', 'professional'),
('123e4567-e89b-12d3-a456-426614174003', '/placeholder.svg', 'Cableado completo de vivienda nueva', 'Instalación Eléctrica', 'professional'),
('123e4567-e89b-12d3-a456-426614174014', '/placeholder.svg', 'Cocina en melamina con detalles en madera', 'Muebles de Cocina', 'professional'),
('123e4567-e89b-12d3-a456-426614174014', '/placeholder.svg', 'Placard empotrado de 3 cuerpos', 'Placards', 'professional'),
('123e4567-e89b-12d3-a456-426614174015', '/placeholder.svg', 'Limpieza post-obra departamento', 'Limpieza Post-Obra', 'professional'),
('123e4567-e89b-12d3-a456-426614174015', '/placeholder.svg', 'Resultado final limpieza profunda', 'Limpieza Doméstica', 'client');