...
const Register = () => {
  ...
  // Servicios disponibles para profesionales - Lista completa de 130+ profesiones
  const serviceCategories = [
    ...
    { name: "Alisadora Profesional", icon: Heart, color: "bg-pink-100 text-pink-600" },
    ...
    { name: "Automatización con IA", icon: Laptop, color: "bg-violet-100 text-violet-600" },
    { name: "Auxiliares de Estudio", icon: Laptop, color: "bg-indigo-100 text-indigo-600" },
    ...
    { name: "Capacitación en Manejo y Programación de Tornos CNC", icon: Laptop, color: "bg-indigo-100 text-indigo-600" },
    ...
    { name: "Cursos/Formación", icon: Laptop, color: "bg-blue-100 text-blue-600" },
    ...
    { name: "Detailing", icon: Car, color: "bg-blue-200 text-blue-700" },
    ...
    { name: "Maquilladora Artística", icon: Heart, color: "bg-pink-300 text-pink-800" },
    ...
    { name: "Piscinas / Piletas Colocación", icon: Building, color: "bg-blue-200 text-blue-700" },
