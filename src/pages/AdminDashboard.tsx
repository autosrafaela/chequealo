      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <TabsList className="flex flex-nowrap w-full overflow-x-auto scrollbar-hide snap-x snap-mandatory gap-2 p-2 pr-16 bg-white/80 backdrop-blur-sm h-auto rounded-2xl shadow-sm border border-border/50 justify-start">
            ...
            <TabsTrigger value="campaigns" className="shrink-0 snap-center min-w-fit text-xs px-3 py-2 rounded-full bg-gray-100/80 hover:bg-primary/10 transition-all data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md border-0">Campañas</TabsTrigger>
            <TabsTrigger value="leads" className="shrink-0 snap-center min-w-fit text-xs px-3 py-2 rounded-full bg-gray-100/80 hover:bg-primary/10 transition-all data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md border-0">Leads</TabsTrigger>
            <TabsTrigger value="moderation" className="shrink-0 snap-center min-w-fit text-xs px-3 py-2 rounded-full bg-gray-100/80 hover:bg-primary/10 transition-all data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md border-0">Moderación</TabsTrigger>
            <TabsTrigger value="subscriptions" className="shrink-0 snap-center min-w-fit text-xs px-3 py-2 rounded-full bg-gray-100/80 hover:bg-primary/10 transition-all data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md border-0">Suscripciones</TabsTrigger>
            <TabsTrigger value="plans" className="shrink-0 snap-center min-w-fit text-xs px-3 py-2 rounded-full bg-gray-100/80 hover:bg-primary/10 transition-all data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md border-0">Planes</TabsTrigger>
            <TabsTrigger value="verifications" className="shrink-0 snap-center min-w-fit text-xs px-3 py-2 rounded-full bg-gray-100/80 hover:bg-primary/10 transition-all data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md border-0">Verificaciones</TabsTrigger>
            <TabsTrigger value="contact-requests" className="shrink-0 snap-center min-w-fit text-xs px-3 py-2 rounded-full bg-gray-100/80 hover:bg-primary/10 transition-all data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md border-0">Solicitudes</TabsTrigger>
            <TabsTrigger value="users" className="shrink-0 snap-center min-w-fit text-xs px-3 py-2 rounded-full bg-gray-100/80 hover:bg-primary/10 transition-all data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md border-0">Usuarios</TabsTrigger>
            <TabsTrigger value="settings" className="shrink-0 snap-center min-w-fit text-xs px-3 py-2 rounded-full bg-gray-100/80 hover:bg-primary/10 transition-all data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md border-0">Configuración</TabsTrigger>
            ...
            <TabsTrigger value="business" className="shrink-0 snap-center min-w-fit text-xs px-3 py-2 rounded-full bg-gray-100/80 hover:bg-primary/10 transition-all data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md border-0">BI</TabsTrigger>
            <TabsTrigger value="performance" className="shrink-0 snap-center min-w-fit text-xs px-3 py-2 rounded-full bg-gray-100/80 hover:bg-primary/10 transition-all data-[state=active]:bg-primary data-[state=active]:text-white data-[state=active]:shadow-md border-0">Monitor</TabsTrigger>
